...
<div class="container-fluid page-body-wrapper">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center navbar-brand-wrapper d-flex ml-4 mt-4 align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="<?= base_url("admin") ?>"><img
                    src="<?= base_url("images/favicon/logo.png") ?>" width="70" class="mr-2" alt="logo" /></a>
        </div>
        <ul class="nav">
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="clients">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("clients/register") ?>">Registro de
                                Cliente</a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("clients") ?>">Lista de
                                Clientes</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#repairs" aria-expanded="false"
                    aria-controls="repairs">
                    <i class="ti ti-layout-list-thumb-alt menu-icon"></i>
                    <span class="menu-title">Reparaciones</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="repairs">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("repairs/register") ?>">Crear
                                Reparacion</a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("repairs") ?>">Lista de
                                Reparaciones</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div class="collapse" id="articles">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("articles/register") ?>">Crear
                                Articulo</a></li>
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("articles") ?>">Lista de
                                Articulos</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#brands" aria-expanded="false" aria-controls="brands">
                    <i class="ti ti-flag menu-icon"></i>
                    <span class="menu-title">Marcas</span>
                    <i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="brands">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("brands/register") ?>">Crear
                                Estado</a></li>
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#states" aria-expanded="false" aria-controls="states">
                ...
                <div class="collapse" id="states">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="<?= base_url("states/register") ?>">Crear
                                Estado</a></li>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                    <div class="card tale-bg">
                        <div class="card-people mt-auto">
                            <img src="<?= base_url("images/auth") ?>" alt="people">
