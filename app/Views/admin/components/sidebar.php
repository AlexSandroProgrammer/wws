...
<head>
    ...
    <title>Panel de Administrador || <?= esc($title) ?></title>
    <!-- plugins:css -->
    ...
    <!-- endinject -->
    <link rel="shortcut icon" href="<?= base_url("images/favicon/favicon.png") ?>" />
</head>
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="<?= base_url("admin") ?>"><img
                        src="<?= base_url("images/favicon/logo.png") ?>" class="mr-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?= base_url("admin") ?>"><img
                        src="<?= base_url("images/favicon/favicon.png") ?>" alt="logo" /></a>
            </div>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <div
                    class="text-center navbar-brand-wrapper d-flex ml-4 mt-4 align-items-center justify-content-center">
                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="clients">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="<?= base_url("clients/register") ?>">Registro de
                                        Cliente</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="repairs">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="<?= base_url("repairs/register") ?>">Crear
                                        Reparacion</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="articles">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="<?= base_url("articles/register") ?>">Crear
                                        Articulo</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#states" aria-expanded="false"
